...
public class RestService {
    ...
    private static final String UI_REST_SERVICE_URL = "http://ui-rest-service/api/messages";
    private static final String UI_REST_WITHOUT_USER_SERVICE_URL = "http://ui-rest-service/api/messageswithoutuser";
...
//    @Retryable(maxAttempts = 5, value = RuntimeException.class, backoff = @Backoff(delay = 50, multiplier = 2))
//    public String getAllMessagesWithoutUser() {
//        String response = template.getForObject(UI_REST_WITHOUT_USER_SERVICE_URL, String.class);
//        log.info(response);
//        return response;
//    }
