...
@DisplayName("Integration-level testing for AdminController")
...
class AdminControllerIntegrationTest {
    ...
    private static final String TEST_ADMIN_URL = "/admin/home";

    @DisplayName("Should return Redirect status")
    @Test
    void shouldReturnRedirectToLogin() {
        ResponseEntity<String> response = restTemplate.getForEntity(TEST_HOST_URL + port + TEST_ADMIN_URL, String.class);
